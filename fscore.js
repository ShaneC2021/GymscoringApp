function fscore() {
  ...
  let bonus = parseFloat(document.getElementById("B").value);
  let penalty = parseFloat(document.getElementById("P").value);

  let deductions = (E1+E2+E3+E4+E5+E6)/6;

  let finalScore =  difficulty + (10 - deductions) + bonus - penalty;

  document.getElementById("final").value = finalScore;
}